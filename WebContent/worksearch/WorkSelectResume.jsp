...
*/
	...
	<body style = "background-color : gray;">
		<h1 align = "center" style = "margin-top: 0px;margin-bottom: 0px;">이력서를 선택해주세요</h1>
				...
				<c:forEach var = "list" items = "${resumelist}">
					<tr>
						<td colspan = "1" align = "center">
							<a class="btn btn-default" href = "WorkSupportLogic.jsp?work_id=${work_id}&&work_no=${work_no}&&work_title=${work_title}&&user_id=${sessionScope.currentid}&&user_resume_num=${list.r_num}&&user_resume_title=${list.r_title}">
							${list.r_num }</a>
						</td>
