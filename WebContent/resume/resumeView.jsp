...
<jsp:include page = "/layout/header.jsp"></jsp:include> 
	<form action = "ResumeUpdateLogic.jsp" method = "post" enctype="multipart/form-data">
				...
				<td colspan = "1"  align ="center"> 
					<c:forEach var = "list" items = "${joblist}" varStatus = "status">
						<input type = "radio" name = "j_head" id = "j_head_id" value = "${list.j_id }"
						 <c:if test="${dto.r_wantjob_head eq list.j_id}">checked</c:if> disabled>${list.j_head_job }<br>
					</c:forEach>
				</td>
				<td colspan = "2" id = "job_middle" >
					<c:forEach var = "listt" items = "${job_mid_list}" varStatus = "status">
						<input type = "radio" name = "j_middle_name" id = "j_middle_id" value = "${listt.j_id}"
						 <c:if test="${dto.r_wantjob_middle eq listt.j_id}">checked</c:if> disabled>${listt.j_middle_job }<br>
					</c:forEach>
				</td>
		...
		<table border = "1" id = "self_id" style = "width : 100%;">
			<tr >
				<td align = "center">자기소개서 작성<br></td>
			</tr>
				<c:if test = "${null == dto.r_self_head_1}">
					<tr id = titleset0 style="display:none;">
						<td align = 'center'>
						<input type = 'text' placeholder = '제목'  style= 'width: 100%; height :30;' id = 'titleid0'name = 'title0' readonly="readonly"><br>
						<textarea style= 'width: 100%; height :100;' id = 'textid0' name = 'area0' readonly="readonly"></textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null != dto.r_self_head_1 }">
					<tr id = titleset0 style="display:'';">
						<td align = 'center'>
						<input type = 'text' value = "${dto.r_self_head_1 }" placeholder = '제목'  style= 'width: 100%; height :30;'  readonly="readonly" id = 'titleid0'name = 'title0'><br>
						<textarea style= 'width: 100%; height :100;'readonly="readonly" id = 'textid0' name = 'area0'>${dto.r_self_text_1}</textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null == dto.r_self_head_2}">
					<tr id = titleset1 style="display:none;">
						<td align = 'center'>
						<input type = 'text' placeholder = '제목'  style= 'width: 100%; height :30;' id = 'titleid1' readonly="readonly" name = 'title1'><br>
						<textarea style= 'width: 100%; height :100;' readonly="readonly"id = 'textid1' name = 'area1'></textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null != dto.r_self_head_2 }">
					<tr id = titleset1 style="display:'';">
						<td align = 'center'>
						<input type = 'text' value = "${dto.r_self_head_2 }" placeholder = '제목'  style= 'width: 100%; height :30;' readonly="readonly" id = 'titleid1'name = 'title1'><br>
						<textarea style= 'width: 100%; height :100;' readonly="readonly"id = 'textid1' name = 'area1'>${dto.r_self_text_2}</textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null == dto.r_self_head_3}">
					<tr id = titleset2 style="display:none;">
						<td align = 'center'>
						<input type = 'text' placeholder = '제목'  style= 'width: 100%; height :30;' readonly="readonly" id = 'titleid2'name = 'title2'><br>
						<textarea style= 'width: 100%; height :100;' readonly="readonly"id = 'textid2' name = 'area2'></textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null != dto.r_self_head_3 }">
					<tr id = titleset2 style="display:'';">
						<td align = 'center'>
						<input type = 'text' value = "${dto.r_self_head_3 }" placeholder = '제목'   readonly="readonly" style= 'width: 100%; height :30;' id = 'titleid2'name = 'title2'><br>
						<textarea style= 'width: 100%; height :100;'readonly="readonly" id = 'textid2' name = 'area2'>${dto.r_self_text_3}</textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null == dto.r_self_head_4}">
					<tr id = titleset3 style="display:none;">
						<td align = 'center'>
						<input type = 'text' placeholder = '제목'  style= 'width: 100%; height :30;'  readonly="readonly"id = 'titleid3'name = 'title3'><br>
						<textarea style= 'width: 100%; height :100;'readonly="readonly" id = 'textid3' name = 'area3'></textarea></td>
					</tr>
				</c:if>
				<c:if test = "${null != dto.r_self_head_4 }">
					<tr id = titleset3 style="display:'';">
						<td align = 'center'>
						<input type = 'text' value = "${dto.r_self_head_4 }" placeholder = '제목' readonly="readonly" style= 'width: 100%; height :30;' id = 'titleid3'name = 'title3'><br>
						<textarea style= 'width: 100%; height :100;'readonly="readonly" id = 'textid3' name = 'area3'>${dto.r_self_text_4}</textarea></td>
					</tr>
				</c:if>
		</table>
		<table border = "1" style = "width : 100%;">
