...
<script type="text/javascript">
	...
	<body style = "background-color : gray;">
		<h1 align = "center" style = " margin-top: 0px;margin-bottom: 0px;">알림장</h1>
					...
					<c:forEach var = "list" items = "${support_list}">
						<tr>
							...
							<td>
								...
								<a class="btn btn-default" href = "/test/worksearch/WorkViewLogic.jsp?no=${list.work_no}&&id=${list.work_id}&&title=${list.work_title}"
								onclick = "GoWorkWiew()">
					...
					<c:forEach var = "list" items = "${arlam_list}">
						<tr>
							...
							<td>
								...
								<a class="btn btn-default" href = "/test/worksearch/WorkViewLogic.jsp?no=${list.company_no}&&title=${list.company_title}&&id=${list.id}&&userid=${list.user_id}"
								onclick = "GoWorkView()">
